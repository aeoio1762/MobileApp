...
import 'package:flutter_login_ui/pages/stdAnfaculties.dart';
...
class stdProfilePage extends StatefulWidget{

  @override
  State<StatefulWidget> createState() {
     return _stdProfilePageState();
  }
}

class _stdProfilePageState extends State<stdProfilePage>{
          ...
          child: ListView(
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => stdAnfaculties()),);
                },
              ),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  Text('Elon Musk', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
                  SizedBox(height: 20,),
