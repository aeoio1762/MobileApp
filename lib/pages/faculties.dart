            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Anfaculties()),
                  );
                },
              ),
              Divider(
            ...
            Row(
              ...
              children: <Widget>[
                ...
                RaisedButton(
                  ...
                  textColor: Colors.white,
                  child: Text(
                      "Faculty of Fine Arts and Architecture".toUpperCase(),
                      style: TextStyle(fontSize: 15)),
                ),
              ],
            ),
            ...
            Row(
              ...
              children: <Widget>[
                ...
                RaisedButton(
                  ...
                  color: Colors.blue,
                  textColor: Colors.white,
                  child: Text("Engineering and Natural Science".toUpperCase(),
                      style: TextStyle(fontSize: 15)),
                ),
              ],
            ),
