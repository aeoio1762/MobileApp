      ...
      body: Container(
        child: Column(
          children:<Widget> [
            ...
            Text("Muhsin Zahid Uğur", style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold, fontSize: 9),),
            Text("We have a lecture today at 10:00 "),
            Divider(color: Theme.of(context).primaryColor, height: 5,),
            Text("Mehmet Kemal Özdemir", style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold, fontSize: 9),),
            Text("We have a lecture today at 13:00 "),
            Divider(color: Theme.of(context).primaryColor, height: 5,),
            Text("Hasan Fehmi Ateş", style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold, fontSize: 9),),
            Text("We have a lecture today at 16:00 "),
            Divider(color: Theme.of(context).primaryColor, height: 5,),
            Text("Bahadır Kürşat Güntürk", style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold, fontSize: 9),),
